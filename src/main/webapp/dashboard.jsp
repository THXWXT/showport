...
<html lang="en">
    ...
    <body>
                ...
                <div class="row my-4">
                                    ...
                                    <div class="card-body">
                                        <div class="card-title">
                                            ...
                                            <div class="col-8">
                                                ...
                                                <form action="dashboard.jsp" method="POST" name="my-form" id="fromdashboard">
                                            </div>
                                            <div class="select">
                                                ...
                                                <select id="list_server" name="cmbSever" onchange="this.form.submit() || saveTolocalStorage()">
                                                    <option value="0" >Select Server</option>
                                                    <%while ((rec != null) && (rec.next())) {%>
                                                    <option value="<%=rec.getInt("server_id")%>" name="server_id"
                                        ...
                                        <%    Connection connect1 = null;
                                            ...
                                            try {
                                                ...
                                                connect1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/projectcloud", "root", "");
                                        ...
                                        <div class="row my-4">
                                            ...
                                            <div class="col-3">
                                                ...
                                                <button type="button" class="btn btn-primary" id="show_port" href="ShowPort">Show port</button>
                                        ...
                                        <div class="row my-4">
                                            <div class="col-6">
                                                ...
                                                <img src="image/imgGraph/dashboard cpu.svg" />
                                            </div>
                                            <div class="col-6">
                                                <h5 class="card-title">Memory</h5> 
                    ...
                    <%                        connect = null;
                        ...
                        try {
                            ...
                            connect = DriverManager.getConnection("jdbc:mysql://localhost:3306/projectcloud", "root", "");
                            s = connect.createStatement();
                            String sql = "select server.server_ip,user.username,port.port_number,port.status from ((port INNER JOIN user ON port.user_id = user.user_id)INNER JOIN server ON port.server_id = server.server_id) where port.status != 'empty';";
                            portUSE = s.executeQuery(sql);
                        } catch (Exception e) {
                            out.println(e.getMessage());
                            e.printStackTrace();
                        }
        ...
        <script>
                                                    ...
                                                    var selectedServerList = document.getElementById("list_server").value;
                                                    console.log(selectedServerList);
                                                    const ServerSelected = document.getElementById("list_server");

                                                    const saveTolocalStorage = () => {
                                                        localStorage.setItem('Select_Server', selectedServerList);
//                                                        document.getElementById("fromdashboard").submit();
                                                    };
                                                    saveTolocalStorage();

                                                    ServerSelected.addEventListener("onchange", () => {
                                                        saveTolocalStorage();
                                                    });

                                                    const storedInput = localStorage.getItem("Select_Server");
                                                    let form = document.forms['my-form'];
                                                    let menu = form.cmbSever;
                                                    let option = form.cmbSever.options;
                                                    console.dir(option);
//                                                    document.getElementById("fromdashboard").submit();
...
//                                                        option[1].selected = true;
                                                        console.log("server select is " + storedInput);
